...
- **Message Flagging & Filtering**: Flag individual user prompts or assistant responses to highlight key insights. Filter the active chat to view only flagged messages, and see flag counts directly in the sidebar.
...
```bash
npm run test:flagging     # Run message flagging test suite
